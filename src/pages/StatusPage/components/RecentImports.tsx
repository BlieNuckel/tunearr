  ...
  return (
    <div className="space-y-2">
      {groupedItems.map((item) => (
        ...
        >
          <div>
            <p className="text-gray-900 dark:text-gray-100 font-medium">{item.album.title}</p>
            <p className="text-gray-500 dark:text-gray-400 text-sm">{item.artist.artistName}</p>
